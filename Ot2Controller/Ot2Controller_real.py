...
:date: (creation)          2020-08-22T22:14:34.026246
:date: (last modification) 2020-08-22T22:14:34.026246
...
USER_STORAGE_DIR = "~/dummy" + "/data/user_storage"
JUPYTER_NOTEBOOK_DIR = "~/dummy" + "/var/lib/jupyter/notebooks"
...
class Ot2ControllerReal:
    ...
    def Get_AvailableProtocols(self, request, context: grpc.ServicerContext) \
        ...
        ssh.connect(Ot2ControllerReal.__device_ip,
    ...
    def Get_AvailableJupyterNotebooks(self, request, context: grpc.ServicerContext) \
        ...
        # Run command.
        ssh_stdin, ssh_stdout, ssh_stderr = ssh.exec_command("ls " + JUPYTER_NOTEBOOK_DIR)
        output = ssh_stdout.readlines()
