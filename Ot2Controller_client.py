...
:date: (creation)          2020-08-15T17:56:45.995016
:date: (last modification) 2020-08-15T17:56:45.995016
...
class Ot2ControllerClient(SiLA2Client):
    ...
    def __init__(self,
                 name: str = "Ot2ControllerClient", description: str = "A SiLA service enabling the execution of python protocols on a Opentrons 2 liquid dispenser robot.",
    ...
    def Get_Connection(self) \
        ...
        return response
    def Get_InstalledProtocols(self) \
            -> Ot2Controller_pb2.Get_InstalledProtocols_Responses:
        """Wrapper to get property InstalledProtocols from the server."""
        # noinspection PyUnusedLocal - type definition, just for convenience
        grpc_err: grpc.Call
    
        logging.debug("Reading unobservable property InstalledProtocols:")
        try:
            response = self.Ot2Controller_stub.Get_InstalledProtocols(
                Ot2Controller_pb2.Get_InstalledProtocols_Parameters()
            )
            logging.debug(
                'Get_InstalledProtocols response: {response}'.format(
                    response=response
                )
            )
        except grpc.RpcError as grpc_err:
